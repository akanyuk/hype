...
$config['module']['comment']['max_tree'] = 3;
...
/* Fluid settings */
$config['view']['grid']['fluid_min_width'] = 870; // Min - 976px
$config['view']['grid']['fluid_max_width'] = 1360;
...
// Customize highlighter by nyuk
$config['head']['default']['js'][] = '___path.static.skin___/js/lang-z80.js';
$config['head']['default']['js'][] = '___path.static.skin___/js/lang-6502.js';
...
$config['head']['default']['css'] = array(
	...
	"___path.static.skin___/css/hype-hl.css",
);
