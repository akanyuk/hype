...
// Модуль Wall - стена
$config['module']['wall']['count_last_reply'] = 3;  // Число последних ответов на сообщение на стене для отображения в ленте
...
// Модуль Rss
$config['module']['rss']['per_page'] = 100;         // Число возвращаемых записей
