...
$config['sys']['mail']['from_email']       = 'bot@hype.retroscene.org';      // Мыло с которого отправляются все уведомления
...
$config['module']['topic']['max_length'] = 65536;       // Максимальное количество символов в одном топике
